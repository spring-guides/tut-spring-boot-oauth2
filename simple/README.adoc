...
You should add some style sheets and JavaScript links so the result looks like this:
...
If you look in the browser tools (F12 on Chrome or Firefox) and follow the network traffic for all the hops, you will see the redirects back and forth with GitHub, and finally you land back on the home page with a new `Set-Cookie` header.
